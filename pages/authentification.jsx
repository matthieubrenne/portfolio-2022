    ...
    <div className="w-full">
      <div className="w-screen h-[50vh] relative">
        ...
        <Image
          ...
          layout="fill"
          objectFit="cover"
          src={authentificationImg}
          alt="image projet"
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">Authentification</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <a
            href="https://github.com/matthieubrenne/authentification"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://authentification-70okdasc7-matthieubrenne.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
